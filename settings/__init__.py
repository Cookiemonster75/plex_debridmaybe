...
settings_list = [
    ...
    ['Library Services', [
        ...
        setting('Library update services', [''], content.classes.refresh, 'active', entry="libary update service", subclass=True,
                radio=False,
                help='Please choose at least one libary update service that plex debrid should update after a complete download. Leave this list empty if an external tool (e.g. WarpBox) handles library scans.'),
